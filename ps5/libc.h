...
_Fn_(void *     , memchr,           const void *, int, size_t);
...
_Fn_(void *     , memmem,           const void *, size_t, const void *, size_t);
...
_Fn_(void*   , memalign,                                 size_t, size_t);
...
_Fn_(uint32_t   , inet_addr,        const char*);
