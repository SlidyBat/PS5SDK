...
// Sony syscalls
_Fn_(int     , _read,                            int fd, void *buf, size_t nbyte);
_Fn_(int     , _write,                           int fd, const void *buf, size_t nbyte);
...
_Fn_(int        , cpuset_getaffinity,               int, int, int64_t, size_t, void*);
_Fn_(int        , cpuset_setaffinity,               int, int, int64_t, size_t, const void*);
...
_Fn_(uint64_t   , __sys_netcontrol,                 int if, unsigned int op, void* buf, unsigned int nbuf);
...
// Underscore variants
_Fn_(uint64_t   , _bind,                                int, void*, int);
...
_Fn_(uint64_t   , sceKernelAioCancelRequest,                    int, int*);
_Fn_(uint64_t   , sceKernelAioCancelRequests,                   int*, int, int*);
_Fn_(uint64_t   , sceKernelAioDeleteRequest,                    int, int*);
_Fn_(uint64_t   , sceKernelAioDeleteRequests,                   int*, int, int*);
_Fn_(uint64_t   , sceKernelAioInitializeImpl,                   void);
_Fn_(uint64_t   , sceKernelAioInitializeParam,                  void);
_Fn_(uint64_t   , sceKernelAioPollRequest,                      int, int*);
_Fn_(uint64_t   , sceKernelAioPollRequests,                     int*, int, int*);
_Fn_(uint64_t   , sceKernelAioSetParam,                         void);
_Fn_(uint64_t   , sceKernelAioSubmitReadCommands,               void*, int, int, int*);
_Fn_(uint64_t   , sceKernelAioSubmitReadCommandsMultiple,       void*, int, int, int*);
_Fn_(uint64_t   , sceKernelAioSubmitWriteCommands,              void*, int, int, int*);
_Fn_(uint64_t   , sceKernelAioSubmitWriteCommandsMultiple,      void*, int, int, int*);
_Fn_(uint64_t   , sceKernelAioWaitRequest,                      int, int*, int*);
_Fn_(uint64_t   , sceKernelAioWaitRequests,                     int*, int, int*, int, int*);
_Fn_(uint64_t   , sceKernelAllocateDirectMemory,                int64_t, int64_t, size_t, size_t, int, int64_t*);
...
_Fn_(uint64_t   , sceKernelMapDirectMemory,                     void**, size_t, int, int, int64_t, size_t);
...
_Fn_(uint64_t   , sceKernelOpen,                                const char *path, int flags, int mode);
...
_Fn_(uint64_t   , sceKernelReleaseDirectMemory,                 int64_t, size_t);
...
_Fn_(int        , sysctlbyname,                                 const char *, void *, size_t *, void *, size_t);
...
_Fn_(pid_t      , waitpid,                                      pid_t, int *, int);
...
_Fn_(int        , sceKernelStreamWriteCreate,                   size_t, int*);
_Fn_(int        , sceKernelStreamWriteDelete,                   int);
